...
ALTER TABLE public.cells_id_seq OWNER TO postgres;
...
ALTER TABLE public.related_id_seq OWNER TO postgres;
...
COPY public.cells (template_id, value, posx, posy, id) FROM stdin;
40	AAAAAAAAAAAA	0	0	98
41	BBBBBBBBBBB	0	1	99
41	DDDDDDDDDDDDD	3	3	100
\.
...
COPY public.templates (id, name, description, columns_count, rows_count, admin_only) FROM stdin;
40	template	template 1	4	5	\N
41	template 2		5	5	\N
42	ftugvj		4	4	\N
43	Шаблон	Шаблона	4	4	\N
\.
...
SELECT pg_catalog.setval('public.cells_id_seq', 100, true);
...
SELECT pg_catalog.setval('public.templates_id_seq', 43, true);
...
--
-- Name: cells fk_customer_id; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cells
    ADD CONSTRAINT fk_customer_id FOREIGN KEY (template_id) REFERENCES public.templates(id);
